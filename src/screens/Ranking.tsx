...
const TABS: { key: RankingTab; label: import("@/i18n/messages").MessageKey }[] = [
  { key: "all", label: "全期間" },
  { key: "week", label: "今週" },
  { key: "speed", label: "⚡清一色" },
    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 p-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-6">
          <h1 className="text-3xl font-black text-white">{t("🏆 ランキング")}</h1>
          <p className="text-gray-400 text-sm mt-1">{t("辻斬り剣客たちの記録")}</p>
        </div>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-gray-400 text-xs">
                    {entry.correctCount}{t("正解 /")}{entry.totalAnswered}{t("問 •")}{" "}
                    {entry.accuracy}%
                  </div>
                </div>
