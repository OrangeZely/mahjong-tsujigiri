    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-900 to-green-950 p-4">
      ...
      >
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-5 mb-2">
          <h2 className="text-white font-bold mb-3">{t("プレミアムでできること")}</h2>
          <ul className="space-y-2 text-sm text-gray-200">
            <li className="flex gap-2">
              <span className="text-yellow-300 shrink-0">✓</span>
              <span>
                <span className="font-bold text-white">{t("プレイ回数が無制限")}</span>
                {t("freeLimit", {limit: DAILY_FREE_PLAYS})}</span>
            </li>
            <li className="flex gap-2">
              <span className="text-yellow-300 shrink-0">✓</span>
              <span>
                <span className="font-bold text-white">{t("広告が非表示")}</span>
                {t("になり、テンポよく解けます")}</span>
            </li>
            <li className="flex gap-2">
              <span className="text-yellow-300 shrink-0">✓</span>
              <span>
                <span className="font-bold text-white">{t("毎月あたらしい問題")}</span>
                {t("が追加されます")}</span>
            </li>
          </ul>
        </div>
